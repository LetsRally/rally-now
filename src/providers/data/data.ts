...
export class DataProvider {
    ...
    linkify(inputText) {
        ...
        replacedText = inputText.replace(replacePattern1, '<a class="link-to" href="$1" target="_parent">$1</a>');

        //URLs starting with "www." (without // before it, or it'd re-link the ones done above).
        replacePattern2 = /(^|[^\/])(www\.[\S]+(\b|$))/gim;
        replacedText = replacedText.replace(replacePattern2, '$1<a class="link-to" href="http://$2" target="_parent">$2</a>');
